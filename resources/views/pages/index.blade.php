                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="selectgroup selectgroup-pills">
                                                    <label class="selectgroup-item">
                                                        <input type="checkbox" name="pallor" value="Pallor" class="selectgroup-input">
                                                        <span class="selectgroup-button">Pallor</span>
                                                    </label>
                                                    <label class="selectgroup-item">
                                                        <input type="checkbox" name="odema" value="Odema" class="selectgroup-input">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="selectgroup selectgroup-pills">
                                                    <label class="selectgroup-item">
                                                        <input type="checkbox" name="cvs" value="CVS" class="selectgroup-input">
                                                        <span class="selectgroup-button">CVS</span>
                                                    </label>
                                                    <label class="selectgroup-item">
                                                        <input type="checkbox" name="rs" value="RS" class="selectgroup-input">
                                                        <span class="selectgroup-button">RS</span>
                                                    </label>
                                                    <label class="selectgroup-item">
                                                        <input type="checkbox" name="cns" value="CNS" class="selectgroup-input">
                                        ...
                                        <div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <select name="heartsound" class="form-control form-select" id="heartsound-dropdown" data-bs-placeholder="Select Heart Sound">
                                                        <option label="Choose one" disabled selected></option>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="breathsound" class="form-control form-select" id="breathsound-dropdown" data-bs-placeholder="Select Breath Sound">
                                                    <option label="Choose one" disabled selected></option>
                                                    <option value="Normal">Normal</option>
                                                    <option value="Abnormal">Abnormal</option>
                                                </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="stressincontinence" class="form-control form-select" id="stressincontinence-dropdown" data-bs-placeholder="Select Stress Incontinence">
                                                    <option label="Choose one" disabled selected></option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" id="tas-uterus" class="form-control" placeholder="cm">
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" id="tvs-uterus" class="form-control" placeholder="Uterus">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="medicalhx" class="form-control form-select" id="medicalhx-dropdown" data-bs-placeholder="Select Medical HX">
                                                    <option label="Choose one" disabled selected></option>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="surgeryhx" class="form-control form-select" id="surgeryhx-dropdown" data-bs-placeholder="Select Surgery HX">
                                                    <option label="Choose one" disabled selected></option>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select name="cervicalconsistency" class="form-control form-select" id="cervicalconsistency-dropdown" data-bs-placeholder="Select Cervical Consistency">
                                                        <option label="Choose one" disabled selected></option>
                                                        <option value="Firm">Firm</option>
                                                        <option value="Soft">Soft</option>
                                                    </select>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select name="cervicalposition" class="form-control form-select" id="cervicalposition-dropdown" data-bs-placeholder="Select Cervical Position">
                                                        <option label="Choose one" disabled selected></option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <select name="urinefullreport" class="form-control form-select" id="urinefullreport-dropdown" data-bs-placeholder="Select Urine Full Report">
                                                            <option label="Choose one" disabled selected></option>
                                                            <option value="Normal">Normal</option>
                                                            <option value="Abnormal">Abnormal</option>
                                                        </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="plandelivery" class="form-control form-select" id="plandelivery-dropdown" data-bs-placeholder="Select Plan Delivery">
                                                    <option label="Choose one" disabled selected></option>
                    ...
                    <div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="selectgroup selectgroup-pills">
                                    <label class="selectgroup-item">
                                        <input type="checkbox" name="ocp" value="OCP" class="selectgroup-input">
                                        <span class="selectgroup-button">OCP</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="checkbox" name="dmpa" value="DMPA" class="selectgroup-input">
                                        <span class="selectgroup-button">DMPA</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="checkbox" name="iud" value="IUD" class="selectgroup-input">
                                        <span class="selectgroup-button">IUD</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="checkbox" name="iucd" value="IUCD" class="selectgroup-input">
                                        <span class="selectgroup-button">IUCD</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="checkbox" name="condom" value="Condom" class="selectgroup-input">
                                        <span class="selectgroup-button">Condom</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="checkbox" name="others" value="Others" class="selectgroup-input">
                                        <span class="selectgroup-button">Others</span>
                                    </label>
                                </div>
                            </div>
